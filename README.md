...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,737 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,781 | 🐛 174 | 🌐 Common Lisp | 📅 2026-09-21 \[Type-L] compiled using LLVM, seamless integration with existing libraries
...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,047 | 🐛 148 | 🌐 Haskell | 📅 2026-09-11 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [Extempore](https://github.com/digego/extempore) ⭐ 1,465 | 🐛 18 | 🌐 C | 📅 2026-09-21 \[Type-S] designed for live coding and music performances, temporal scheduling based on audio card sample rate
...
* [let-go](https://github.com/nooga/let-go) ⭐ 563 | 🐛 179 | 🌐 Go | 📅 2026-09-22 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Squint](https://github.com/squint-cljs/squint) ⭐ 902 | 🐛 21 | 🌐 Clojure | 📅 2026-09-21 \[Type-C] Squint is a light-weight dialect of ClojureScript with a compiler and standard library
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,584 | 🐛 79 | 🌐 Rust | 📅 2026-09-20 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,737 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
