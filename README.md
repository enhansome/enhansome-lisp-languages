...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,715 | 🐛 47 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
...
* [Wax](https://github.com/LingDong-/wax) ⭐ 854 | 🐛 15 | 🌐 C | 📅 2025-03-03 \[Type-A] tiny programming language, strongly statically typed, manual memory management, transpiles to C, C++, Java, TypeScript, Python, C#, Swift, Lua and WebAssembly
...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,782 | 🐛 170 | 🌐 Common Lisp | 📅 2026-08-18 \[Type-L] compiled using LLVM, seamless integration with existing libraries
...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,008 | 🐛 140 | 🌐 Haskell | 📅 2026-08-03 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [Extempore](https://github.com/digego/extempore) ⭐ 1,468 | 🐛 18 | 🌐 C | 📅 2026-07-22 \[Type-S] designed for live coding and music performances, temporal scheduling based on audio card sample rate
...
* [Toccata](https://github.com/Toccata-Lang/toccata) ⭐ 8 | 🐛 0 | 🌐 C | 📅 2026-08-18 \[Type-C] Clojure-inspired, gradually typed, no nil values, reference counting, compiles into native binaries
...
* [Clojure CLR](https://github.com/clojure/clojure-clr) ⭐ 1,651 | 🐛 0 | 🌐 C# | 📅 2026-07-20 \[Type-C] great for game development with arcadia and unity
...
* [let-go](https://github.com/nooga/let-go) ⭐ 551 | 🐛 125 | 🌐 Go | 📅 2026-08-18 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,538 | 🐛 78 | 🌐 Rust | 📅 2026-08-17 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,715 | 🐛 47 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
...
* Lisps for Microcontrollers
  * [LispBM](https://github.com/svenssonjoel/lispBM) ⭐ 132 | 🐛 3 | 🌐 C | 📅 2026-08-07 (LBM) - concurrency and message passing influenced by Erlang, threads with mailbox, pattern-matching
