...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,722 | 🐛 53 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
...
* [Coalton](https://github.com/coalton-lang/coalton) ⭐ 1,752 | 🐛 194 | 🌐 Common Lisp | 📅 2026-08-15 \[Type-L] efficient, statically typed functional programming language that supercharges Common Lisp
...
* [Toccata](https://github.com/Toccata-Lang/toccata) ⭐ 8 | 🐛 0 | 🌐 C | 📅 2026-08-27 \[Type-C] Clojure-inspired, gradually typed, no nil values, reference counting, compiles into native binaries
...
* [ClojureDart](https://github.com/Tensegritics/ClojureDart) ⭐ 1,636 | 🐛 123 | 🌐 Clojure | 📅 2026-08-24 \[Type-C] clojure dialect for Flutter and Dart
...
* [let-go](https://github.com/nooga/let-go) ⭐ 553 | 🐛 148 | 🌐 Go | 📅 2026-08-28 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,555 | 🐛 79 | 🌐 Rust | 📅 2026-08-27 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,722 | 🐛 53 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
...
* Lisps for Microcontrollers
  * [LispBM](https://github.com/svenssonjoel/lispBM) ⭐ 132 | 🐛 3 | 🌐 C | 📅 2026-08-28 (LBM) - concurrency and message passing influenced by Erlang, threads with mailbox, pattern-matching
