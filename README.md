...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,012 | 🐛 138 | 🌐 Haskell | 📅 2026-08-24 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,544 | 🐛 77 | 🌐 Rust | 📅 2026-08-24 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
