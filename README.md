...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,782 | 🐛 176 | 🌐 Common Lisp | 📅 2026-08-30 \[Type-L] compiled using LLVM, seamless integration with existing libraries
...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,020 | 🐛 140 | 🌐 Haskell | 📅 2026-08-24 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [let-go](https://github.com/nooga/let-go) ⭐ 554 | 🐛 146 | 🌐 Go | 📅 2026-08-30 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,560 | 🐛 77 | 🌐 Rust | 📅 2026-08-29 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
