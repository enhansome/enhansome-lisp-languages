...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,728 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,033 | 🐛 144 | 🌐 Haskell | 📅 2026-09-11 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [Toccata](https://github.com/Toccata-Lang/toccata) ⭐ 8 | 🐛 0 | 🌐 C | 📅 2026-09-10 \[Type-C] Clojure-inspired, gradually typed, no nil values, reference counting, compiles into native binaries
...
* [Clojure CLR](https://github.com/clojure/clojure-clr) ⭐ 1,655 | 🐛 0 | 🌐 C# | 📅 2026-09-10 \[Type-C] great for game development with arcadia and unity
...
* [let-go](https://github.com/nooga/let-go) ⭐ 555 | 🐛 141 | 🌐 Go | 📅 2026-09-12 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Squint](https://github.com/squint-cljs/squint) ⭐ 901 | 🐛 24 | 🌐 Clojure | 📅 2026-09-03 \[Type-C] Squint is a light-weight dialect of ClojureScript with a compiler and standard library
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,728 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
