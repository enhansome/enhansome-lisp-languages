...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,781 | 🐛 169 | 🌐 Common Lisp | 📅 2026-08-10 \[Type-L] compiled using LLVM, seamless integration with existing libraries
* [Coalton](https://github.com/coalton-lang/coalton) ⭐ 1,741 | 🐛 194 | 🌐 Common Lisp | 📅 2026-08-15 \[Type-L] efficient, statically typed functional programming language that supercharges Common Lisp
...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,007 | 🐛 140 | 🌐 Haskell | 📅 2026-08-03 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [let-go](https://github.com/nooga/let-go) ⭐ 550 | 🐛 125 | 🌐 Go | 📅 2026-08-17 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,535 | 🐛 78 | 🌐 Rust | 📅 2026-08-17 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
