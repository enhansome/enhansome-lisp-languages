...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,734 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
* [Lux](https://github.com/LuxLang/lux) ⭐ 1,740 | 🐛 0 | 🌐 Emacs Lisp | 📅 2026-08-26 \[Type-B] functional, statically-typed Lisp that will run on several platforms
* [Wax](https://github.com/LingDong-/wax) ⭐ 857 | 🐛 15 | 🌐 C | 📅 2025-03-03 \[Type-A] tiny programming language, strongly statically typed, manual memory management, transpiles to C, C++, Java, TypeScript, Python, C#, Swift, Lua and WebAssembly
* [Ribbit](https://github.com/udem-dlteam/ribbit) ⭐ 564 | 🐛 21 | 🌐 Scheme | 📅 2026-09-17 \[Type-S] small and portable Scheme implementation (R4RS, 4 KB footprint), AOT and incremental compilers, targets C, JavaScript, Python and Scheme
...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,781 | 🐛 173 | 🌐 Common Lisp | 📅 2026-09-17 \[Type-L] compiled using LLVM, seamless integration with existing libraries
* [Coalton](https://github.com/coalton-lang/coalton) ⭐ 1,757 | 🐛 189 | 🌐 Common Lisp | 📅 2026-09-15 \[Type-L] efficient, statically typed functional programming language that supercharges Common Lisp
...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,045 | 🐛 148 | 🌐 Haskell | 📅 2026-09-11 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [Extempore](https://github.com/digego/extempore) ⭐ 1,464 | 🐛 18 | 🌐 C | 📅 2026-09-10 \[Type-S] designed for live coding and music performances, temporal scheduling based on audio card sample rate
...
* [Clojure CLR](https://github.com/clojure/clojure-clr) ⭐ 1,654 | 🐛 0 | 🌐 C# | 📅 2026-09-12 \[Type-C] great for game development with arcadia and unity
...
* [ClojureDart](https://github.com/Tensegritics/ClojureDart) ⭐ 1,644 | 🐛 126 | 🌐 Clojure | 📅 2026-09-17 \[Type-C] clojure dialect for Flutter and Dart

### Erlang

* [Clojerl](https://github.com/clojerl/clojerl) ⭐ 1,714 | 🐛 11 | 🌐 Erlang | 📅 2025-01-07 \[Type-C]
...
* [let-go](https://github.com/nooga/let-go) ⭐ 556 | 🐛 146 | 🌐 Go | 📅 2026-09-18 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Venice](https://github.com/jlangch/venice) ⭐ 47 | 🐛 0 | 🌐 Java | 📅 2026-09-14 \[Type-C] Clojure-inspired, sandboxed, Java interop, 800+ builtin functions
...
* [Squint](https://github.com/squint-cljs/squint) ⭐ 902 | 🐛 20 | 🌐 Clojure | 📅 2026-09-17 \[Type-C] Squint is a light-weight dialect of ClojureScript with a compiler and standard library
...
* [nu](https://github.com/programming-nu/nu) ⭐ 2,186 | 🐛 19 | 🌐 Objective-C | 📅 2023-07-11 \[?] interpreted
...
* [Hy](https://github.com/hylang/hy) ⭐ 5,439 | 🐛 9 | 🌐 Python | 📅 2026-07-31 \[Type-A] compiles to Python AST, use Python ML libraries, runs on PyPy
* [Pixie](https://github.com/pixie-lang/pixie) ⭐ 2,356 | 🐛 55 | 🌐 Python | 📅 2020-10-28 \[Type-B] Clojure inspired, written in RPython, custom GC and JIT
* [Basilisp](https://github.com/basilisp-lang/basilisp) ⭐ 478 | 🐛 47 | 🌐 Python | 📅 2026-08-02 \[Type-C] Clojure-compatible, targeting Python3.6+
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,579 | 🐛 79 | 🌐 Rust | 📅 2026-09-16 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,734 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
...
* [Liz](https://github.com/dundalek/liz) ⭐ 292 | 🐛 0 | 🌐 Clojure | 📅 2021-10-02 \[Type-A] general purpose programming language, supports WASM compilation target
* [Schism](https://github.com/schism-lang/schism) ⭐ 221 | 🐛 2 | 📅 2020-06-02 \[Type-S] self-hosting compiler from a subset of R6RS Scheme to WebAssembly
...
* Lisps for Microcontrollers
  * [LispBM](https://github.com/svenssonjoel/lispBM) ⭐ 134 | 🐛 3 | 🌐 C | 📅 2026-09-17 (LBM) - concurrency and message passing influenced by Erlang, threads with mailbox, pattern-matching
