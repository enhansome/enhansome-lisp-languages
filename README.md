...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,738 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
* [Lux](https://github.com/LuxLang/lux) ⭐ 1,740 | 🐛 0 | 🌐 Emacs Lisp | 📅 2026-09-21 \[Type-B] functional, statically-typed Lisp that will run on several platforms
...
* [Ribbit](https://github.com/udem-dlteam/ribbit) ⭐ 566 | 🐛 22 | 🌐 Scheme | 📅 2026-09-18 \[Type-S] small and portable Scheme implementation (R4RS, 4 KB footprint), AOT and incremental compilers, targets C, JavaScript, Python and Scheme
...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,782 | 🐛 173 | 🌐 Common Lisp | 📅 2026-09-22 \[Type-L] compiled using LLVM, seamless integration with existing libraries
* [Coalton](https://github.com/coalton-lang/coalton) ⭐ 1,759 | 🐛 190 | 🌐 Common Lisp | 📅 2026-09-15 \[Type-L] efficient, statically typed functional programming language that supercharges Common Lisp
...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,048 | 🐛 149 | 🌐 Haskell | 📅 2026-09-11 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [Extempore](https://github.com/digego/extempore) ⭐ 1,464 | 🐛 18 | 🌐 C | 📅 2026-09-22 \[Type-S] designed for live coding and music performances, temporal scheduling based on audio card sample rate
...
* [let-go](https://github.com/nooga/let-go) ⭐ 564 | 🐛 180 | 🌐 Go | 📅 2026-09-23 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Squint](https://github.com/squint-cljs/squint) ⭐ 902 | 🐛 21 | 🌐 Clojure | 📅 2026-09-22 \[Type-C] Squint is a light-weight dialect of ClojureScript with a compiler and standard library
...
* [nu](https://github.com/programming-nu/nu) ⭐ 2,185 | 🐛 19 | 🌐 Objective-C | 📅 2023-07-11 \[?] interpreted
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,585 | 🐛 80 | 🌐 Rust | 📅 2026-09-20 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,738 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
...
* Lisps for Microcontrollers
  * [LispBM](https://github.com/svenssonjoel/lispBM) ⭐ 155 | 🐛 3 | 🌐 C | 📅 2026-09-21 (LBM) - concurrency and message passing influenced by Erlang, threads with mailbox, pattern-matching
