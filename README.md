...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,780 | 🐛 174 | 🌐 Common Lisp | 📅 2026-09-18 \[Type-L] compiled using LLVM, seamless integration with existing libraries
* [Coalton](https://github.com/coalton-lang/coalton) ⭐ 1,757 | 🐛 190 | 🌐 Common Lisp | 📅 2026-09-15 \[Type-L] efficient, statically typed functional programming language that supercharges Common Lisp
...
* [ClojureDart](https://github.com/Tensegritics/ClojureDart) ⭐ 1,644 | 🐛 126 | 🌐 Clojure | 📅 2026-09-18 \[Type-C] clojure dialect for Flutter and Dart
...
* [let-go](https://github.com/nooga/let-go) ⭐ 556 | 🐛 145 | 🌐 Go | 📅 2026-09-19 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Hy](https://github.com/hylang/hy) ⭐ 5,440 | 🐛 9 | 🌐 Python | 📅 2026-07-31 \[Type-A] compiles to Python AST, use Python ML libraries, runs on PyPy
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,580 | 🐛 79 | 🌐 Rust | 📅 2026-09-16 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
