...
* [let-go](https://github.com/nooga/let-go) ⭐ 553 | 🐛 141 | 🌐 Go | 📅 2026-08-21 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,542 | 🐛 79 | 🌐 Rust | 📅 2026-08-20 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
