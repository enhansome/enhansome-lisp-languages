...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,729 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,782 | 🐛 179 | 🌐 Common Lisp | 📅 2026-09-10 \[Type-L] compiled using LLVM, seamless integration with existing libraries
* [Coalton](https://github.com/coalton-lang/coalton) ⭐ 1,756 | 🐛 190 | 🌐 Common Lisp | 📅 2026-09-11 \[Type-L] efficient, statically typed functional programming language that supercharges Common Lisp
...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,036 | 🐛 144 | 🌐 Haskell | 📅 2026-09-11 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [let-go](https://github.com/nooga/let-go) ⭐ 555 | 🐛 151 | 🌐 Go | 📅 2026-09-12 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Hy](https://github.com/hylang/hy) ⭐ 5,437 | 🐛 9 | 🌐 Python | 📅 2026-07-31 \[Type-A] compiles to Python AST, use Python ML libraries, runs on PyPy
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,729 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
