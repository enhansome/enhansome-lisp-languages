...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,727 | 🐛 54 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
...
* [Clojure CLR](https://github.com/clojure/clojure-clr) ⭐ 1,655 | 🐛 0 | 🌐 C# | 📅 2026-09-03 \[Type-C] great for game development with arcadia and unity
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,727 | 🐛 54 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
