...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,736 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,780 | 🐛 174 | 🌐 Common Lisp | 📅 2026-09-20 \[Type-L] compiled using LLVM, seamless integration with existing libraries
...
* [let-go](https://github.com/nooga/let-go) ⭐ 560 | 🐛 165 | 🌐 Go | 📅 2026-09-20 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,581 | 🐛 79 | 🌐 Rust | 📅 2026-09-20 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,736 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
...
* Lisps for Microcontrollers
  * [LispBM](https://github.com/svenssonjoel/lispBM) ⭐ 152 | 🐛 3 | 🌐 C | 📅 2026-09-17 (LBM) - concurrency and message passing influenced by Erlang, threads with mailbox, pattern-matching
