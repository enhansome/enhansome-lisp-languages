...
* [ClojureDart](https://github.com/Tensegritics/ClojureDart) ⭐ 1,640 | 🐛 124 | 🌐 Clojure | 📅 2026-08-24 \[Type-C] clojure dialect for Flutter and Dart
...
* [let-go](https://github.com/nooga/let-go) ⭐ 554 | 🐛 137 | 🌐 Go | 📅 2026-09-04 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,570 | 🐛 79 | 🌐 Rust | 📅 2026-09-04 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* Lisps for Microcontrollers
  * [LispBM](https://github.com/svenssonjoel/lispBM) ⭐ 134 | 🐛 3 | 🌐 C | 📅 2026-09-05 (LBM) - concurrency and message passing influenced by Erlang, threads with mailbox, pattern-matching
