...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,781 | 🐛 168 | 🌐 Common Lisp | 📅 2026-08-10 \[Type-L] compiled using LLVM, seamless integration with existing libraries
...
* [Toccata](https://github.com/Toccata-Lang/toccata) ⭐ 8 | 🐛 0 | 🌐 C | 📅 2026-07-28 \[Type-C] Clojure-inspired, gradually typed, no nil values, reference counting, compiles into native binaries
...
* [ClojureDart](https://github.com/Tensegritics/ClojureDart) ⭐ 1,632 | 🐛 123 | 🌐 Clojure | 📅 2026-07-21 \[Type-C] clojure dialect for Flutter and Dart
...
* [let-go](https://github.com/nooga/let-go) ⭐ 547 | 🐛 126 | 🌐 Go | 📅 2026-08-14 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,529 | 🐛 79 | 🌐 Rust | 📅 2026-08-12 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* Lisps for Microcontrollers
  * [LispBM](https://github.com/svenssonjoel/lispBM) ⭐ 130 | 🐛 3 | 🌐 C | 📅 2026-08-07 (LBM) - concurrency and message passing influenced by Erlang, threads with mailbox, pattern-matching
