...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,733 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
...
* [Ribbit](https://github.com/udem-dlteam/ribbit) ⭐ 565 | 🐛 22 | 🌐 Scheme | 📅 2026-09-18 \[Type-S] small and portable Scheme implementation (R4RS, 4 KB footprint), AOT and incremental compilers, targets C, JavaScript, Python and Scheme
...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,780 | 🐛 173 | 🌐 Common Lisp | 📅 2026-09-19 \[Type-L] compiled using LLVM, seamless integration with existing libraries
* [Coalton](https://github.com/coalton-lang/coalton) ⭐ 1,758 | 🐛 190 | 🌐 Common Lisp | 📅 2026-09-15 \[Type-L] efficient, statically typed functional programming language that supercharges Common Lisp
...
* [Extempore](https://github.com/digego/extempore) ⭐ 1,465 | 🐛 18 | 🌐 C | 📅 2026-09-10 \[Type-S] designed for live coding and music performances, temporal scheduling based on audio card sample rate
...
* [ClojureDart](https://github.com/Tensegritics/ClojureDart) ⭐ 1,644 | 🐛 125 | 🌐 Clojure | 📅 2026-09-18 \[Type-C] clojure dialect for Flutter and Dart
...
* [let-go](https://github.com/nooga/let-go) ⭐ 557 | 🐛 152 | 🌐 Go | 📅 2026-09-20 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Basilisp](https://github.com/basilisp-lang/basilisp) ⭐ 479 | 🐛 47 | 🌐 Python | 📅 2026-08-02 \[Type-C] Clojure-compatible, targeting Python3.6+
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,581 | 🐛 79 | 🌐 Rust | 📅 2026-09-19 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,733 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
...
* Lisps for Microcontrollers
  * [LispBM](https://github.com/svenssonjoel/lispBM) ⭐ 146 | 🐛 3 | 🌐 C | 📅 2026-09-17 (LBM) - concurrency and message passing influenced by Erlang, threads with mailbox, pattern-matching
