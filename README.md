...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,732 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
...
* [Ribbit](https://github.com/udem-dlteam/ribbit) ⭐ 563 | 🐛 21 | 🌐 Scheme | 📅 2026-08-31 \[Type-S] small and portable Scheme implementation (R4RS, 4 KB footprint), AOT and incremental compilers, targets C, JavaScript, Python and Scheme
...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,782 | 🐛 174 | 🌐 Common Lisp | 📅 2026-09-15 \[Type-L] compiled using LLVM, seamless integration with existing libraries
* [Coalton](https://github.com/coalton-lang/coalton) ⭐ 1,757 | 🐛 190 | 🌐 Common Lisp | 📅 2026-09-11 \[Type-L] efficient, statically typed functional programming language that supercharges Common Lisp
...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,043 | 🐛 148 | 🌐 Haskell | 📅 2026-09-11 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [Toccata](https://github.com/Toccata-Lang/toccata) ⭐ 8 | 🐛 0 | 🌐 C | 📅 2026-09-13 \[Type-C] Clojure-inspired, gradually typed, no nil values, reference counting, compiles into native binaries
...
* [ClojureDart](https://github.com/Tensegritics/ClojureDart) ⭐ 1,643 | 🐛 126 | 🌐 Clojure | 📅 2026-08-24 \[Type-C] clojure dialect for Flutter and Dart
...
* [let-go](https://github.com/nooga/let-go) ⭐ 556 | 🐛 150 | 🌐 Go | 📅 2026-09-15 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Squint](https://github.com/squint-cljs/squint) ⭐ 901 | 🐛 22 | 🌐 Clojure | 📅 2026-09-12 \[Type-C] Squint is a light-weight dialect of ClojureScript with a compiler and standard library
...
* [Hy](https://github.com/hylang/hy) ⭐ 5,438 | 🐛 9 | 🌐 Python | 📅 2026-07-31 \[Type-A] compiles to Python AST, use Python ML libraries, runs on PyPy
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,575 | 🐛 79 | 🌐 Rust | 📅 2026-09-09 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,732 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
...
* Lisps for Microcontrollers
  * [LispBM](https://github.com/svenssonjoel/lispBM) ⭐ 134 | 🐛 3 | 🌐 C | 📅 2026-09-06 (LBM) - concurrency and message passing influenced by Erlang, threads with mailbox, pattern-matching
