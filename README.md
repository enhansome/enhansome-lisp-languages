...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,712 | 🐛 47 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
* [Lux](https://github.com/LuxLang/lux) ⭐ 1,739 | 🐛 0 | 🌐 Emacs Lisp | 📅 2026-08-05 \[Type-B] functional, statically-typed Lisp that will run on several platforms
...
* [Ribbit](https://github.com/udem-dlteam/ribbit) ⭐ 562 | 🐛 20 | 🌐 Scheme | 📅 2026-08-14 \[Type-S] small and portable Scheme implementation (R4RS, 4 KB footprint), AOT and incremental compilers, targets C, JavaScript, Python and Scheme
...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,782 | 🐛 168 | 🌐 Common Lisp | 📅 2026-08-10 \[Type-L] compiled using LLVM, seamless integration with existing libraries
* [Coalton](https://github.com/coalton-lang/coalton) ⭐ 1,742 | 🐛 194 | 🌐 Common Lisp | 📅 2026-08-15 \[Type-L] efficient, statically typed functional programming language that supercharges Common Lisp
...
* [C-Mera](https://github.com/kiselgra/c-mera) ⭐ 452 | 🐛 26 | 🌐 Common Lisp | 📅 2026-03-07 \[Type-A] also includes extensions to generate code to run on CUDA, GLSL
...
* [Toccata](https://github.com/Toccata-Lang/toccata) ⭐ 8 | 🐛 0 | 🌐 C | 📅 2026-08-15 \[Type-C] Clojure-inspired, gradually typed, no nil values, reference counting, compiles into native binaries
...
* [Clojure CLR](https://github.com/clojure/clojure-clr) ⭐ 1,652 | 🐛 0 | 🌐 C# | 📅 2026-07-20 \[Type-C] great for game development with arcadia and unity
...
* [ClojureDart](https://github.com/Tensegritics/ClojureDart) ⭐ 1,633 | 🐛 123 | 🌐 Clojure | 📅 2026-07-21 \[Type-C] clojure dialect for Flutter and Dart
...
* [let-go](https://github.com/nooga/let-go) ⭐ 548 | 🐛 127 | 🌐 Go | 📅 2026-08-15 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Armed Bear Clojure](https://github.com/lsevero/abclj) ⭐ 93 | 🐛 4 | 🌐 Clojure | 📅 2021-04-27 \[Type-C+L] Common Lisp embedded in Clojure via ABCL
* [Venice](https://github.com/jlangch/venice) ⭐ 46 | 🐛 0 | 🌐 Java | 📅 2026-07-31 \[Type-C] Clojure-inspired, sandboxed, Java interop, 800+ builtin functions
...
* [Squint](https://github.com/squint-cljs/squint) ⭐ 895 | 🐛 20 | 🌐 Clojure | 📅 2026-08-12 \[Type-C] Squint is a light-weight dialect of ClojureScript with a compiler and standard library
...
* [DreamLisp](https://github.com/jsloop42/dreamlisp) ⭐ 8 | 🐛 0 | 🌐 Objective-C | 📅 2026-02-22 \[Type-B] Clojure-inspired, originally based on MAL, added modules, lazy collections
...
* [Basilisp](https://github.com/basilisp-lang/basilisp) ⭐ 476 | 🐛 46 | 🌐 Python | 📅 2026-08-02 \[Type-C] Clojure-compatible, targeting Python3.6+
* [Hissp](https://github.com/gilch/hissp) ⭐ 449 | 🐛 30 | 🌐 Python | 📅 2026-08-06 \[Type-A] compiles to a functional subset of Python, macro metaprogramming with Python ecosystem
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,534 | 🐛 78 | 🌐 Rust | 📅 2026-08-15 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 506 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,712 | 🐛 47 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
...
* [Bel](http://paulgraham.com/bel.html) - self-hosted lisp dialect, see also markdown formatted [mirror](https://github.com/alephyud/bel) ⭐ 52 | 🐛 1 | 🌐 Common Lisp | 📅 2022-09-25
  ...
  * [Language::Bel](https://github.com/masak/bel) ⭐ 28 | 🐛 80 | 🌐 Perl | 📅 2026-01-16 - implementation of Bel in Perl 5, includes extensive test suite
...
* Lisps for Microcontrollers
  * [LispBM](https://github.com/svenssonjoel/lispBM) ⭐ 131 | 🐛 3 | 🌐 C | 📅 2026-08-07 (LBM) - concurrency and message passing influenced by Erlang, threads with mailbox, pattern-matching
