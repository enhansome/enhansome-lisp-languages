...
* [Mal](https://github.com/kanaka/mal) ⭐ 10,730 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22 is an educational lisp with implementations in dozens of languages. It is a great resource for learning about lisp implementation.
...
* [Clasp](https://github.com/clasp-developers/clasp) ⭐ 2,781 | 🐛 174 | 🌐 Common Lisp | 📅 2026-09-13 \[Type-L] compiled using LLVM, seamless integration with existing libraries
...
* [Carp](https://github.com/carp-lang/Carp) ⭐ 6,041 | 🐛 147 | 🌐 Haskell | 📅 2026-09-11 \[Type-B] statically typed, no GC (Rust-like borrow checking)
...
* [let-go](https://github.com/nooga/let-go) ⭐ 555 | 🐛 147 | 🌐 Go | 📅 2026-09-13 \[Type-C] compiler, bytecode VM, Go interop, small footprint, fast booting
...
* [Steel](https://github.com/mattwparas/steel) ⭐ 2,573 | 🐛 79 | 🌐 Rust | 📅 2026-09-09 \[Type-S] embedded scheme interpreter in Rust, inspired by Racket
...
* [Fleck](https://github.com/chr15m/flk/) ⭐ 507 | 🐛 1 | 🌐 Shell | 📅 2021-12-18 \[Type-A] Clojure-like, based on [Mal](https://github.com/kanaka/mal/) ⭐ 10,730 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22, packaged as single-file Bash script
